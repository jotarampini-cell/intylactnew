        ...
        {actives.map((a, i) => (
          ...
          >
            <Reveal delay={i * 100} className="h-full">
              <article
                className={`flex h-full flex-col rounded-[16px] bg-gradient-to-br ${a.tint} p-6 transition-transform duration-500 hover:-translate-y-1.5 sm:rounded-[18px] sm:p-7`}
              >
